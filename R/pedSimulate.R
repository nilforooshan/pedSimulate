...
#'
#' @details
#' Starting from a base population with equal number of males and females,
#' next generations are simulated for a user-defined number of generations.
#' The size of the base population is defined by the user.
...
#' different proportion of selected individuals from selection candidates (after applying mortality) as parents of the next generation,
#' random or merit-based selection, and generation overlap.
#' Selected individuals are mated randomly using function \code{\link{simulatePed}},
#' or mated assortatively/disassortatively using function \code{\link{assortative}}.
#' In assortative/disassortative mating, males and females are sorted for mating based on the criteria for which they have been selected for
#' (can be different between males and females).
